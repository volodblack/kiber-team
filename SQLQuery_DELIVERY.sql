...
('3','4','2018-01-26','12','438'),
('2','5','2018-01-26','15','238'),
('1','6','2018-02-21','32','869'),
('4','11','2018-02-06','30','456'),
('1','3','2018-03-19','10','675'),
('4','1','2018-05-10','12','968'),
('3','9','2018-05-30','4','643'),
('2','13','2018-06-09','75','230'),
('1','12','2018-07-14','6','785'),
('1','2','2018-08-25','15','432'),
('2','7','2018-09-07','10','874'),
('3','10','2018-09-11','50','376'),
('4','8','2018-09-28','6','945')
go
...
('1','3','Х1','О1','1','Х1_2','О1_2','2018-09-12','2018-09-15','50'),
('2','4','В1','Ч1','2','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('3','5','Х1','О1','3','Х1_2','О1_2','2018-09-12','2018-09-15','100'),
('4','4','В1','Т1','4','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('5','3','Х1','Т1','5','Х1_2','О1_2','2018-09-12','2018-09-15','120'),
('6','4','В1','Ч1','6','В1_1','Ч1_1','2018-09-13','2018-09-16','60'),
('7','3','Х1','Т1','7','Х1_2','О1_2','2018-09-12','2018-09-15','110'),
('8','4','В1','Ч1','8','В1_1','Ч1_1','2018-09-13','2018-09-16','40'),
('9','3','Х1','О1','9','Х1_2','О1_2','2018-09-12','2018-09-15','120'),
('10','4','В1','Ч1','10','В1_1','Ч1_1','2018-09-13','2018-09-16','40'),
('11','3','Х1','О1','11','Х1_2','О1_2','2018-09-12','2018-09-15','180'),
('12','4','В1','Ч1','12','В1_1','Ч1_1','2018-09-13','2018-09-16','810'),
('13','3','Х1','О1','13','Х1_2','О1_2','2018-09-12','2018-09-15','130'),
('14','4','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','50'),
('15','3','Х1','І1','12','Х1_2','О1_2','2018-09-12','2018-09-15','50'),
('16','4','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','180'),
('1','13','Х1','О1','12','Х1_2','О1_2','2018-09-12','2018-09-15','10'),
('2','14','В1','І1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('3','13','Х1','О1','7','Х1_2','О1_2','2018-09-12','2018-09-15','50'),
('4','14','В1','І1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('5','13','Х1','О1','8','Х1_2','О1_2','2018-09-12','2018-09-15','50'),
('6','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('7','13','Х1','О1','6','Х1_2','О1_2','2018-09-12','2018-09-15','150'),
('8','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','90'),
('9','13','Х1','О1','7','Х1_2','О1_2','2018-09-12','2018-09-15','50'),
('10','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','180'),
('11','13','Х1','О1','5','Х1_2','О1_2','2018-09-12','2018-09-15','125'),
('12','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','200'),
('13','13','Х1','О1','4','Х1_2','О1_2','2018-09-12','2018-09-15','140'),
('14','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','140'),
('15','13','Х1','О1','6','Х1_2','О1_2','2018-09-12','2018-09-15','130'),
('16','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','810'),
('1','3','Х1','О1','7','Х1_2','О1_2','2018-09-12','2018-09-15','155'),
('2','4','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','85'),
('3','3','Х1','О1','6','Х1_2','О1_2','2018-09-12','2018-09-15','130'),
('4','4','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','70'),
('5','3','Х1','О1','7','Х1_2','О1_2','2018-09-12','2018-09-15','130'),
('6','4','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('7','3','Х1','О1','5','Х1_2','О1_2','2018-09-12','2018-09-15','120'),
('8','4','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','30'),
('9','3','Х1','О1','2','Х1_2','О1_2','2018-09-12','2018-09-15','160'),
('10','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','60'),
('11','13','Х1','О1','12','Х1_2','О1_2','2018-09-12','2018-09-15','170'),
('12','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','70'),
('12','13','Х1','О1','12','Х1_2','О1_2','2018-09-12','2018-09-15','140'),
('12','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','280'),
('12','13','Х1','О1','12','Х1_2','О1_2','2018-09-12','2018-09-15','130'),
('13','14','В1','Ч1','13','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('13','3','Х1','О1','12','Х1_2','О1_2','2018-09-12','2018-09-15','150'),
('14','4','В1','Ч1','1','В1_1','Ч1_1','2018-09-13','2018-09-16','100'),
('15','13','Х1','О1','2','Х1_2','О1_2','2018-09-12','2018-09-15','120'),
('16','14','В1','Ч1','1','В1_1','Ч1_1','2018-09-13','2018-09-16','75'),
('11','13','Х1','О1','2','Х1_2','О1_2','2018-09-12','2018-09-15','125'),
('1','4','В1','Ч1','1','В1_1','Ч1_1','2018-09-13','2018-09-16','75'),
('2','3','Х1','О1','2','Х1_2','О1_2','2018-09-12','2018-09-15','125'),
('2','4','В1','Ч1','1','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('2','3','Х1','О1','2','Х1_2','О1_2','2018-09-12','2018-09-15','150'),
('2','4','В1','Ч1','1','В1_1','Ч1_1','2018-09-13','2018-09-16','80'),
('2','3','Х1','О1','2','Х1_2','О1_2','2018-09-12','2018-09-15','150')
go

/* дані про працівника який обслуговував відправника з прізвищем 'Романченко' де вартість доставки = 180*/
SELECT distinct Прізвище, Імя, [Номер тел] FROM Працівники
JOIN Замовлення ON Працівники.Id = Замовлення.[Id оп. відправника]
WHERE Замовлення.[Id відпрівника] = (
	select id from Клієнти 
	where Прізвище = 'Романченко'
	And Замовлення.[Вартість доставки] = 180)

/* скільки разів клієнт Івашків відправив якесь замовлення --- 3 */
select COUNT (Замовлення.Id) from Замовлення 
join Клієнти on Замовлення.[Id відпрівника] = Клієнти.Id
where [Id відпрівника] = (
	select id from Клієнти 
	where Прізвище = 'Івашків')

/* дані про відправників, які відправляли товар в Чернігівську обл 2018-09-16 */
select distinct [Прізвище],[Імя],[По-батькові],[Номер тел],[Email] from Клієнти
join Замовлення on Клієнти.Id = Замовлення.[Id відпрівника]
where Замовлення.[Id відділення отримуача] = 'Ч1'
and Замовлення.[Дата отримання] = '2018-09-16'
order by [Прізвище] asc

/* дані про відправників, вартість доставки яких між 70 та 90 або імя закінчується на "нко" */
select distinct [Прізвище],[Імя],[По-батькові],[Номер тел],[Email] from Клієнти
join Замовлення on Клієнти.Id = Замовлення.[Id відпрівника]
where Замовлення.[Вартість доставки] between 70 and 90
or Клієнти.Імя like '%нко'

/* вибрати прізвища отримувачів у яких упаковка не є однією з: 'Картонний тубус', 'Стрейч-плівка', 'Коробка для ноутбука', 'Ящик для автоскла'*/ 
select distinct Прізвище,[Імя],[Номер тел] from Клієнти
join Замовлення on Замовлення.[Id отримувача] = Клієнти.Id
join Упаковка on Упаковка.Id = Замовлення.[Id упаковки]
where Упаковка.Назва not in ('Картонний тубус','Стрейч-плівка','Коробка для ноутбука','Ящик для автоскла')
go
select Прізвище, імя , [По-батькові]/* Прізвище, імя , По-батькові клієнтів які зробили замовлень  на суму більшу за 155 у ролі відправника або отримувача */
from Клієнти
where id in (Select  [Id відпрівника]
from Замовлення
group by [Id відпрівника]
having sum([Вартість доставки])>155)
UNION 
select Прізвище, імя , [По-батькові]
from Клієнти
where id in (Select  [Id отримувача]
from Замовлення
group by [Id отримувача]
having sum([Вартість доставки])>155 )
go

Select Прізвище  , імя ,count([Id відпрівника]) [Кількість відправлень ]/*Прізвище  , імя ,Кількість відправлень кожного з клієнтів */
from Замовлення З
right join Клієнти  as к on к.Id = з.[Id відпрівника]
group by Прізвище, імя  ,[Id відпрівника]
order by count([Id відпрівника]) desc
go
Select Прізвище  , імя , [Назва типу ]/*Визначення назви типу клієнта */
from  Клієнти к
left join Замовлення as з on к.Id = з.[Id відпрівника]
